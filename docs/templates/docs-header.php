...
<div id="rd-header" class="row">
    <div class="col-md-8 col-lg-9">
        <ul class="list-inline">
            ...
            <li>
                <a href="<?php echo RDFunctions::make_link('explore', ['by' => 'recent']); ?>"><?php _e('Recent Documents', 'docs'); ?></a>
            </li>
            <li>
                <a href="<?php echo RDFunctions::make_link('explore', ['by' => 'top']); ?>"><?php _e('Top Documents', 'docs'); ?></a>
            </li>
        </ul>
    </div>
