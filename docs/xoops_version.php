...
$modversion = [
    ...
    'rmversion' => ['major' => 1, 'minor' => 0, 'revision' => 21, 'stage' => -2, 'name' => 'Documentor'],
    'rewrite' => 0,
    ...
    # Social
    'social' => [
        ['title' => __('Twitter', 'mywords'), 'type' => 'twitter', 'url' => 'http://www.twitter.com/bitcero/'],
        ['title' => __('Facebook', 'mywords'), 'type' => 'facebook', 'url' => 'http://www.facebook.com/eduardo.cortes.hervis/'],
        ['title' => __('Instagram', 'mywords'), 'type' => 'instagram', 'url' => 'http://www.instagram.com/eduardocortesh/'],
        ['title' => __('Flickr', 'mywords'), 'type' => 'flickr', 'url' => 'http://www.flickr.com/photos/bitcero/'],
        ['title' => __('LinkedIn', 'mywords'), 'type' => 'linkedin', 'url' => 'http://www.linkedin.com/in/bitcero/'],
        ['title' => __('GithHub', 'mywords'), 'type' => 'github', 'url' => 'http://www.github.com/bitcero/'],
        ['title' => __('My Blog', 'mywords'), 'type' => 'blog', 'url' => 'http://eduardocortes.mx'],
    ],
    ...
    'config' => [
        [
            ...
            'valuetype' => 'int',
            'default' => 0,
            'options' => [__('PHP Default', 'docs') => 0, __('Name based', 'docs') => 1],
        ],
        ...
        [
            ...
            'description' => __('This option affects the creation of new documents in front end. Administrators will continue creating documents in back end.', 'docs'),
            'formtype' => 'yesno',
            'valuetype' => 'int',
            'default' => 1,
        ],
        ...
        [
            'category' => 'general',
            'name' => 'standalone_css',
            'title' => __('Style sheet for standalone display', 'docs'),
            'description' => '',
            'formtype' => 'textbox',
            'valuetype' => 'text',
